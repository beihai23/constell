...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\bnickname\x18\x03 \x01(\tR\bnickname\"\x92\x01\n" +
	...
	"\n" +
	"expires_at\x18\x03 \x01(\x03R\texpiresAt2\xd3\x01\n" +
	"\vAuthService\x12?\n" +
	...
	"\fRefreshToken\x12\x1c.auth.v1.RefreshTokenRequest\x1a\x1d.auth.v1.RefreshTokenResponseB\x94\x01\n" +
	"\vcom.auth.v1B\tAuthProtoP\x01Z=github.com/constell/constell/backend/pkg/proto/auth/v1;authv1\xa2\x02\x03AXX\xaa\x02\aAuth.V1\xca\x02\aAuth\\V1\xe2\x02\x13Auth\\V1\\GPBMetadata\xea\x02\bAuth::V1b\x06proto3"
